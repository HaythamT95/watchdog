...
/*
	...
	Input:  argv - contain also the name of your executable file
			...
			max_failures - watchdog will re-execute your program after max_failures_num_ passed with no received signal
	...
	Notes:	1. you can use this function only on multi-threaded machine
			2. you can't call this function several times in a row
	 		3. in this function we create process for execute run_watchdog - make sure that you doesn't
	       	   change his name or his path.
	        4. after calling this function you can't use SIGUSR1, SIGUSR2, and SIGKILL
	        5. if you didn't call StopWD after you call this function, it will lead to undefined behavior
*/
int MakeMeImmortal(int argc, char *argv[], size_t interval, size_t max_failures);
